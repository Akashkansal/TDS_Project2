...
def save_readme(df, analysis_summary, story):
    with open("README.md", "w") as f:
        ...
        f.write("5. **Cluster Analysis:**\n")
        f.write("   - Natural groupings were identified using clustering algorithms.\n")
        f.write("   - Cluster assignments were added to the dataset for further exploration.\n\n")
        f.write("6. **Geographic Analysis:**\n")
